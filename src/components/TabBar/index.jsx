...
function TabBar(props) {
    return(
        <nav className="TabBar">
            ...
            <a className="tab_icon_center_around"><img className="tab_icon_center" src={more}alt="https://cdn-icons.flaticon.com/png/512/2997/premium/2997933.png?token=exp=1638387361~hmac=2dda82ab78dfd479bd257e9cb3784dd0" /></a>
